...
\addtobeamertemplate{headline}{}
{
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node [anchor=north west, inner sep=2cm] at (current page.north west)
      {\includegraphics[height=3.0cm]{mitlogos/mit_logo_std_rgb_mit-red.eps}}; % also try shield-white.eps
    ...
    \begin{column}{\colwidth}
      \begin{alertblock}{Introduction}
        \begin{itemize}
          ...
          \item \citet{chappellVariationGrammaticalizationComplementizers2008,huangControlComplementsMandarin2018}: \emph{shuo} is a complementizer, strong evidence that deontic modals are clause/CP-embedding:
           ...
           \begin{tcolorbox}[title=The  takeaway,colback=red!15!white,colbacktitle=red!15!white,opacityfill=1]
      ...
      \begin{block}{Test 2: Scope of focus-sensitive operators}
        \begin{itemize}
          ...
          \item The presupposition is derived if we assume that 1) \textbf{\emph{ye} is interpreted in an embedded position below \emph{keyi}}, and that 2) \textbf{presuppositions project universally and epistemically} from under deontic modals à la \citet{heimPresuppositionProjectionSemantics1992}.
      ...
      \begin{block}{Test 3: Distribution of focus-sensitive operators}
        \begin{itemize}
          ...
          % \item Both \Next and \NNext mean `Lisi\F{} also wrote the paper.'
            \begin{tcolorbox}[title={\topobj{} must precede \opfs{} without modals}]
              \ex. \begingl
          ...
          % \item Ignoring the modal, \Next has the sequence in \NNext:
            \begin{tcolorbox}[title={\topobj{} can follow \opfs{} with modals}]
              \ex.
              \begingl
